      ...
      <div className="py-16 bg-base-200">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-10">
            <Link to="/issues" className="btn btn-outline btn-wide">
              View All Issues
            </Link>
          </div>
        </div>
      ...
      <div className="py-20 bg-base-100 text-center container mx-auto px-4">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-lg text-gray-600">
            Be a hero in your community. Sign up for our weekly clean-up drives
            and make a visible difference.
          </p>
          <Link
            to="auth/login"
            className="btn btn-accent btn-lg rounded-full px-10 shadow-lg"
          >
            Become a Volunteer
          </Link>
        </div>
