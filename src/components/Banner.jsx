...
import { ArrowRight, Leaf, Trash2, Users } from "lucide-react";

const Banner = () => {
  const [currentSlide, setCurrentSlide] = useState(0);

  // Slide Data: Real-world visuals
  const slides = [
    {
      id: 1,
      image:
      ...
      description:
        "Over 2 billion tons of garbage is generated annually. Our landfills are overflowing, and our oceans are suffering. The crisis is visible, urgent, and demands attention.",
      color: "text-red-500",
    },
    {
      id: 2,
      ...
      description:
        "Real change starts locally. Join thousands of volunteers coming together to reclaim our streets, parks, and beaches from waste.",
      color: "text-blue-500",
    },
    {
      id: 3,
      ...
      description:
        "Sustainability isn't just a buzzword; it's survival. Adopt eco-friendly habits, recycle smarter, and help us build a world that lasts.",
      color: "text-green-500", // Accent color substitute
    },
  ];
      ...
      <div className="relative z-20 h-full container mx-auto px-4 flex flex-col justify-center items-center text-center">
        ...
        <AnimatePresence mode="wait">
          <div key={currentSlide} className="max-w-3xl space-y-6">
            ...
            >
              <span
                className={`px-3 py-1 rounded-full text-sm font-bold uppercase tracking-wider bg-white/10 backdrop-blur-md border border-white/20 text-white`}
              >
